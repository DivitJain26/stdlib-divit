...
tape( 'the function returns `true` if both arrays have equal values (mixed 64-bit integer arrays)', function test( t ) {
	...
	// Values exceeding the maximum safe integer (2^60 and 2^64-2^11):
	x = new Uint64Array([
		1,
		Uint64.of( 268435456, 0 ),
		Uint64.of( 4294967295, 4294965248 )
	]);
	y = new Float64Array([
		1.0,
	...
	// Negative values and values exceeding the maximum safe integer (-2^63, -2^32, and 2^63-2^10):
	x = new Int64Array([
		Int64.of( 2147483648, 0 ),
		-4294967296,
		-1,
		0,
		1,
		Int64.of( 2147483647, 4294966272 )
	]);
	y = new Float64Array([
	...
	x = new Uint64Array( [ 0, 1, 2, 4294967295 ] );
	y = new Uint32Array( [ 0, 1, 2, 4294967295 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, true, 'returns expected value' );
	...
	x = new Int64Array( [ -2147483648, -1, 0, 2147483647 ] );
	y = new Int32Array( [ -2147483648, -1, 0, 2147483647 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, true, 'returns expected value' );
	...
	x = new Uint64Array( [ 0, 1, 2, 255 ] );
	y = new Uint8Array( [ 0, 1, 2, 255 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, true, 'returns expected value' );

	x = new Int64Array( [ -128, -1, 0, 127 ] );
	y = new Int8Array( [ -128, -1, 0, 127 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, true, 'returns expected value' );
...
tape( 'the function returns `false` if both arrays do not have equal values (mixed 64-bit integer arrays)', function test( t ) {
	var out;
	var x;
	var y;

	// Same bit pattern, but different values (2^64-1 and -1):
	x = new Uint64Array( [ 0, Uint64.of( 4294967295, 4294967295 ) ] );
	...
	x = new Uint64Array( [ Uint64.of( 1, 1 ) ] );
	y = new Float64Array( [ 1.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );

	x = new Uint64Array( [ 1 ] );
	y = new Float64Array( [ 4294967297.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );

	// Same high word, but different low words (2^32+1 and 2^32+2):
	x = new Uint64Array( [ Uint64.of( 1, 1 ) ] );
	y = new Float64Array( [ 4294967298.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );
	...
	x = new Uint64Array( [ 0 ] );
	y = new Float64Array( [ 18446744073709551616.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );

	// Values which cannot be represented as 64-bit signed integers (-2^63 versus 2^63 and -2^63-2^11):
	x = new Int64Array( [ Int64.of( 2147483648, 0 ) ] );
	y = new Float64Array( [ 9223372036854775808.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );

	y = new Float64Array( [ -9223372036854777856.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );
	...
	y = new Uint32Array( [ 4294967295 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );

	// Non-numeric values:
	x = new Uint64Array( [ 1, 2 ] );
	y = [ '1', '2' ];
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );
	...
	y = new Complex128Array( [ 1.0, 0.0, 2.0, 0.0 ] );
	out = hasEqualValues( x, y );
	t.strictEqual( out, false, 'returns expected value' );
